            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-mono text-primary">{getSponsorshipNumber(selectedStudent.id)}</p>
                  <Badge className={`text-xs capitalize mt-1 ${statusColors[selectedStudent.status] || ""}`}>
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-foreground">{levelLabels[selectedStudent.education_level] || selectedStudent.education_level}</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-foreground">{selectedStudent.class_grade || "—"}</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-foreground">{selectedStudent.district || "—"}</p>
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-semibold text-foreground">{selectedStudent.current_school || "—"}</p>
                </div>
              </div>

              <div className="border-t pt-3">
                <p className="text-xs text-muted-foreground font-semibold mb-2 flex items-center gap-1">
                  <User size={12} /> Parent / Guardian
                </p>
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div>
                    <p className="text-muted-foreground text-xs">Name</p>
                    <p className="font-semibold text-foreground">{selectedStudent.parent_name}</p>
                  </div>
                  <div className="flex items-start gap-2">
                    <Phone size={14} className="text-muted-foreground mt-0.5 shrink-0" />
                    <div>
                      <p className="text-muted-foreground text-xs">Phone</p>
                      <p className="font-semibold text-foreground">{selectedStudent.parent_phone}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {selectedStudent.reason && (
                <div className="border-t pt-3">
                  <p className="text-muted-foreground text-xs mb-1">Reason for Application</p>
                  <p className="text-sm text-foreground">{selectedStudent.reason}</p>
                </div>
              )}
              ...
              {selectedStudent.admin_notes && (
                <div className="border-t pt-3">
                  ...
                  <p className="text-sm text-foreground">{selectedStudent.admin_notes}</p>
                </div>
              )}

              <div className="border-t pt-3 text-xs text-muted-foreground">
                Applied: {new Date(selectedStudent.created_at).toLocaleDateString()} · ID: {selectedStudent.id.slice(0, 8)}...
              </div>
            </div>
          )}
        </DialogContent>
